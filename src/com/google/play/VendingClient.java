...
public class VendingClient extends Client {
	...
	protected static void prepareConnection(final HttpURLConnection connection, final RequestInfo info) {
	...
	public static Requests.RequestProto createRequestProto(Requests.RequestPropertiesProto props) {
	...
	public static Requests.RequestProto.Request createRequest(Asset.AssetsRequestProto request) {
		return new Requests.RequestProto.Request().setAssetRequest(request);
	}

	public static Requests.RequestProto.Request createRequest(Unsorted.GetMarketMetadataRequestProto request) {
		return new Requests.RequestProto.Request().setGetMarketMetadataRequest(request);
	}

	public static Requests.RequestProto.Request createRequest(Unsorted.ContentSyncRequestProto request) {
		return new Requests.RequestProto.Request().setContentSyncRequest(request);
	}

	public static Requests.RequestProto addRequestToProto(Requests.RequestProto builder,
														  Requests.RequestProto.Request request) {
		return builder.addRequest(request);
	}

	public static Unsorted.ContentSyncResponseProto sendRequest(Requests.RequestPropertiesProto props,
	...
	public static Unsorted.GetMarketMetadataResponseProto sendRequest(Requests.RequestPropertiesProto props,
	...
	public static Asset.AssetsResponseProto sendRequest(Requests.RequestPropertiesProto props,
	...
	public static List<Asset.AssetsResponseProto> sendAssetRequests(Requests.RequestPropertiesProto props,
	...
	public static List<Requests.ResponseProto.Response> sendRequests(Requests.RequestPropertiesProto props,
	...
	public static Requests.ResponseProto.Response sendRequest(Requests.RequestPropertiesProto props,
	...
	public static Requests.ResponseProto sendRequest(final Requests.RequestProto request, final RequestInfo info) {
		byte[] bytes = null;
		try {
	...
	private static byte[] sendString(final HttpURLConnection connection, final String string, final RequestInfo info) {
